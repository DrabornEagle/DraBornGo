...
export default function GameFlow({ session, onSignedOut, dkd_on_home_ready_value = () => {}, dkd_device_permissions_enabled_flag = true }) {
  ...
  const hasVisibleModal = useMemo(() => getHasVisibleModal({ actionMenuOpen, profileOpen, courierBoardOpen, activeTab, adminMenuOpen }), [actionMenuOpen, profileOpen, courierBoardOpen, activeTab, adminMenuOpen]);
