        ...
        <KeyboardAvoidingView style={dkd_styles_value.screen} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          <LinearGradient colors={['#050B18', '#091A2A', '#160D2D']} style={dkd_styles_value.screen}>
            <View style={dkd_styles_value.header}>
              <View style={{ flex: 1 }}><Text style={dkd_styles_value.kicker}>DraBornGo v0.0.16</Text><Text style={dkd_styles_value.title}>Kullanıcı Kimliği</Text><Text style={dkd_styles_value.sub}>Profilini, kurye onay durumunu ve hesap ayarlarını buradan yönet.</Text></View>
