...
export const dkd_service_network_category_groups_value = [
  ...
  { dkd_group_id_value: 'dkd_special_delivery', dkd_title_value: 'Özel Teslimat', dkd_subtitle_value: 'Hediye, çiçek, etkinlik ve özel teslimat akışları', dkd_icon_value: 'gift-open-outline', dkd_gradient_value: ['#831843', '#C026D3', '#4F46E5'], dkd_categories_value: [
...
const dkd_service_network_mode_blueprints_value = {
  ...
  dkd_market_delivery: {
    ...
    dkd_logic_title_value: 'Ürün seçimi + teslim notu + hızlı teslim mantığı',
...
const dkd_service_network_request_blueprints_value = {
  ...
  dkd_taxi: { dkd_primary_question_value: 'Alış noktası, varış noktası, kişi sayısı ve araç tercihi alınır.', dkd_address_placeholder_value: 'Alış adresi veya canlı konum notu', dkd_delivery_placeholder_value: 'Varış adresi ve rota detayı', dkd_detail_placeholder_value: 'Kişi sayısı, valiz, çocuk koltuğu, evcil hayvan, bekleme ve rota notu', dkd_photo_note_value: 'Konum ekran görüntüsü veya buluşma noktası fotoğrafı', dkd_option_values: ['Hemen çağır', 'Randevulu taksi', 'Valizli araç', 'Sabit teklif'], dkd_flow_values: ['Sürücü mesafe/ücret teklifini verir', 'Plaka ve sürücü profili görünür', 'Varışta tamamlandı ve değerlendirme açılır'] },
