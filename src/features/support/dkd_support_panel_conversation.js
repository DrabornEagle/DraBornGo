...
const dkd_support_storage_key = 'dkd_dkd_draborngo_support_drafts_v2';
          ...
          >
            ...
            <View style={dkd_styles.dkd_header_row}>
              ...
              <View style={dkd_styles.dkd_header_text_block}>
                <Text style={dkd_styles.dkd_kicker}>{dkd_is_admin_user ? 'DKD ADMIN SUPPORT' : 'DraBornGo DESTEK'}</Text>
                <Text style={dkd_styles.dkd_title}>Destek Paneli</Text>
                <Text style={dkd_styles.dkd_subtitle}>
                  {dkd_is_admin_user
                    ? 'Talepleriniz hemen cevaplanır'
                      ...
                      return (
                        ...
                        >
                          <Text style={dkd_styles.dkd_message_sender}>
                            {dkd_message_item.dkd_sender_title || (dkd_ai_message ? 'DraBornGo AI Destek' : dkd_admin_message ? 'Destek Ekibi' : 'Müşteri')}
                          </Text>
