...
const styles = StyleSheet.create({
  ...
  kicker: { color: '#7EEBFF', fontSize: 9, fontWeight: '900', letterSpacing: 1.35 },
  ...
  liveText: { color: '#A6F5D3', fontSize: 8, fontWeight: '900' },
  ...
  threadMeta: { color: '#8EDFFF', fontSize: 10, fontWeight: '800', marginTop: 2 },
  threadPreview: { color: 'rgba(229,240,255,.58)', fontSize: 10.5, lineHeight: 15, marginTop: 5 },
  ...
  backUser: { flex: 1, textAlign: 'right', color: 'rgba(6,17,27,.72)', fontSize: 10, fontWeight: '800' },
  messages: { flex: 1 },
  ...
  messageSender: { color: '#CFF6FF', fontSize: 9, fontWeight: '900' },
  messageTime: { color: 'rgba(230,241,255,.45)', fontSize: 8, fontWeight: '700' },
