...
const dkd_styles_value = StyleSheet.create({
  ...
  dkd_kicker: { color: '#82E9FF', fontSize: 11, fontWeight: '900', letterSpacing: 1.3 },
  ...
  dkd_inbox_info_text: { flex: 1, color: 'rgba(234,245,255,.64)', fontSize: 11.5, lineHeight: 14, fontWeight: '700' },
  ...
  dkd_thread_meta: { color: '#8DE6FF', fontSize: 12.5, fontWeight: '800', marginTop: 3 },
  dkd_thread_preview: { color: 'rgba(235,244,255,.54)', fontSize: 12.5, lineHeight: 15, fontWeight: '700', marginTop: 5 },
  ...
  dkd_message_badge_text: { color: '#06111B', fontSize: 11, fontWeight: '900' },
  ...
  dkd_search_badge_text: { color: '#FFE0A0', fontSize: 11, fontWeight: '900' },
  ...
  dkd_more_text: { color: '#CFF7FF', fontSize: 12.5, fontWeight: '900' },
  ...
  dkd_selected_user_meta: { color: 'rgba(224,241,255,.56)', fontSize: 11.5, fontWeight: '700', marginTop: 2 },
  ...
  dkd_admin_role: { color: 'rgba(230,241,255,.55)', fontSize: 11.5, fontWeight: '700', marginTop: 2 },
  ...
  dkd_live_text: { color: '#9CF1CE', fontSize: 11, fontWeight: '900' },
  ...
  dkd_message_sender: { color: '#DDF8FF', fontSize: 11, fontWeight: '900' },
  dkd_message_time: { color: 'rgba(235,245,255,.50)', fontSize: 11, fontWeight: '700' },
