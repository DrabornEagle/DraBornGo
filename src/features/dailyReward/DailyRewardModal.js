...
function DailyRewardModal({
  ...
  const preview = state?.rewardPreview || { puan: 0, xp: 0, label: 'Günlük ödül', cycleDay: 1 };
        ...
        <LinearGradient colors={['#08111D', '#101D34', '#0B1426']} style={{ width: '100%', maxWidth: 460, maxHeight: '92%', borderRadius: 30, paddingHorizontal: 16, paddingVertical: 16, borderWidth: 1, borderColor: 'rgba(120,155,225,0.18)' }}>
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 8 }}>
              ...
              <LinearGradient colors={['#0E5A4C', '#0E2344']} style={{ paddingHorizontal: 16, paddingVertical: 16 }}>
                ...
                <Text style={{ color: 'rgba(229,241,255,0.78)', fontSize: 13, fontWeight: '700', lineHeight: 20, marginTop: 8 }}>
                  {state?.claimedToday
                    ...
                    : `Bugünün ödülü hazır. ${Number(preview?.puan || 0)} puan ve ${Number(preview?.xp || 0)} XP alarak ${currentDay}. günü tamamlayabilirsin.`}
                </Text>
              </LinearGradient>
            </View>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginTop: 14 }}>
              ...
              <View style={{ width: '49%' }}><MiniStat label="BUGÜN" value={`${Number(preview?.puan || 0)} puan`} sub={`${Number(preview?.xp || 0)} XP`} accent="rgba(139,255,183,0.18)" /></View>
            ...
            {milestones.length ? (
              <>
                <SectionTitle title="Seri Milestone Ödülleri" subtitle="3 / 5 / 7 gün serilerinde ekstra puan ve bonus ödül kazan." />
