...
function dkd_get_metric_meta(metric) {
  ...
  if (dkd_metric_key_value === 'boss') {
    return {
      ...
      unitLabel: 'hedef',
      icon: 'sword-cross',
      modeLabel: 'Özel hedef modu',
      emptyText: 'Özel hedefler ilerledikçe tablo dolacak.',
      rowSubText: 'Haftalık hedef gücü',
      heroBadgeText: 'hedef',
  ...
  return {
    ...
    icon: 'cash-multiple',
    modeLabel: 'Puan modu',
    emptyText: 'Puan akışı geldikçe tablo dolacak.',
    rowSubText: 'Haftalık puan toplamı',
    heroBadgeText: 'puan',
    seasonLeadText: 'Sezon lideri',
    sectionRewardTitle: 'Sezon ödülü',
    sectionRewardSub: 'Ödül sadece geçen hafta kapanan sezon için alınır. Bu yüzden buton yalnızca “Geçen hafta” görünümünde aktif olur.',
  ...
  const headerComponent = useMemo(() => (
    <>
      ...
      <SectionCard>
        ...
        <View style={styles.toggleRow}>
          <Toggle label="Puan" active={metric === 'puan'} onPress={() => onMetricChange?.('puan')} />
      ...
      <SectionCard>
        ...
        {metric === 'courier' ? (
          <View style={styles.rewardInfoBox}>
            ...
            <Text style={styles.rewardInfoLine}>Ödül paketi: koleksiyon kartı, 10-100 puan, 5-40 koleksiyon puanı, 3 özel kart.</Text>
          </View>
        ) : (
