...
const dkd_styles = StyleSheet.create({
  ...
  dkd_signal_node_text: { color: '#E0F2FE', fontSize: 12, fontWeight: '900' },
  ...
  dkd_login_preview_footer_text: { color: 'rgba(231,241,255,0.88)', fontSize: 12, fontWeight: '900' },
  ...
  dkd_card_kicker: { color: '#86EFAC', fontSize: 12, fontWeight: '900', letterSpacing: 1.2, marginBottom: 2 },
  ...
  dkd_modal_section_kicker: { color: '#72FFBF', fontSize: 12, fontWeight: '900', letterSpacing: 1.1 },
