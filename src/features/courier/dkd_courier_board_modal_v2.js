...
const dkd_styles_value = StyleSheet.create({
  ...
  dkd_kicker: { color: '#7EEBFF', fontSize: 11, fontWeight: '900', letterSpacing: 1.3 },
  dkd_title: { color: '#FFFFFF', fontSize: 27, fontWeight: '900', marginTop: 2 },
  dkd_sub: { color: 'rgba(235,244,255,.60)', fontSize: 12.5, lineHeight: 15, fontWeight: '700', marginTop: 3 },
  ...
  dkd_status_hero: { minHeight: 300, borderRadius: 29, padding: 16, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(137,230,255,.20)' },
  ...
  dkd_status_kicker: { color: 'rgba(226,245,255,.72)', fontSize: 11, fontWeight: '900', letterSpacing: 1.2 },
  dkd_status_title: { color: '#FFFFFF', fontSize: 21, lineHeight: 26, fontWeight: '900', marginTop: 4 },
  dkd_status_sub: { color: 'rgba(235,245,255,.72)', fontSize: 12.5, lineHeight: 18, fontWeight: '700', marginTop: 5 },
  dkd_status_metrics: { flexDirection: 'row', gap: 7, marginTop: 16 },
  dkd_metric: { flex: 1, minHeight: 72, borderRadius: 17, padding: 9, backgroundColor: 'rgba(2,9,20,.27)', borderWidth: 1, borderColor: 'rgba(255,255,255,.08)' },
  dkd_metric_label: { color: 'rgba(229,243,255,.58)', fontSize: 11.5, fontWeight: '900', letterSpacing: .75 },
  dkd_metric_value: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', marginTop: 6 },
  dkd_status_button: { minHeight: 58, borderRadius: 19, marginTop: 14, paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#7EEBFF' },
  dkd_status_button_text: { color: '#06111B', fontSize: 14, fontWeight: '900' },
  dkd_section_header: { marginTop: 22, marginBottom: 9, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' },
  dkd_section_kicker: { color: '#83E9FF', fontSize: 11, fontWeight: '900', letterSpacing: 1.2 },
  ...
  dkd_help_text: { flex: 1, color: 'rgba(226,244,255,.62)', fontSize: 11.3, lineHeight: 14, fontWeight: '700' },
  ...
  dkd_job_kicker: { color: '#A9EEFF', fontSize: 11, fontWeight: '900', letterSpacing: .9 },
  dkd_job_title: { color: '#FFFFFF', fontSize: 15, lineHeight: 19, fontWeight: '900', marginTop: 2 },
  dkd_job_status: { color: '#8EF0C1', fontSize: 11.5, fontWeight: '800', marginTop: 3 },
  ...
  dkd_fee_label: { color: 'rgba(255,232,178,.55)', fontSize: 11, fontWeight: '900', letterSpacing: .7 },
  ...
  dkd_route_step_text: { color: 'rgba(229,240,255,.46)', fontSize: 11, fontWeight: '800', marginTop: 4 },
  ...
  dkd_address_label: { color: 'rgba(218,239,255,.48)', fontSize: 11, fontWeight: '900', letterSpacing: .7 },
  dkd_address_text: { color: '#FFFFFF', fontSize: 12.5, lineHeight: 15, fontWeight: '700', marginTop: 3 },
  ...
  dkd_note_text: { flex: 1, color: 'rgba(255,239,199,.67)', fontSize: 11.5, lineHeight: 14, fontWeight: '700' },
  ...
  dkd_primary_action_text: { color: '#06111B', fontSize: 12.5, fontWeight: '900' },
  ...
  dkd_secondary_action_text: { color: '#FFFFFF', fontSize: 12.5, fontWeight: '900' },
  ...
  dkd_empty_text: { color: 'rgba(235,244,255,.56)', fontSize: 12.5, lineHeight: 16, fontWeight: '700', textAlign: 'center', marginTop: 5, maxWidth: 280 },
});
