...
import DkdServicePartnerApplicationPanel from './dkd_service_partner_application_panel';

const dkd_colors_value = cityLootTheme.colors;

export default function DkdApplicationsHubModalValue({
  dkd_visible_value,
  dkd_on_close_value,
  dkd_profile_value,
  ...
  const dkd_title_text_value = dkd_active_application_value === 'courier' ? 'Kurye Başvurusu' : dkd_active_application_value === 'logistics' ? 'Nakliye Başvurusu' : dkd_active_application_value === 'servicePartner' ? 'Hizmet Ağı İşletme Başvurusu' : 'Başvurular';
  const dkd_subtitle_text_value = dkd_active_application_value === 'courier'
    ...
    : dkd_active_application_value === 'logistics'
      ...
      : dkd_active_application_value === 'servicePartner'
        ? 'Hizmet Ağı işletme formu aynı Başvurular sayfasında açıldı. Bütün hizmet grupları ve kategorileri tek akışta seçilebilir.'
        : 'Kurye, nakliye ve hizmet ağı işletme başvurularını tek merkezden aç. Operasyon kartları burada, sipariş ve gönderi akışı ayrı merkezde kalır.';
        ...
        <LinearGradient colors={['#050B18', '#081527', '#120A24']} style={dkd_styles_value.dkd_screen}>
          <ScrollView contentContainerStyle={dkd_styles_value.dkd_content} showsVerticalScrollIndicator={false}>
            ...
            <View style={dkd_styles_value.dkd_grid}>
              ...
              <Pressable
                onPress={() => dkd_set_active_application_value('servicePartner')}
                style={({ pressed: dkd_pressed_value }) => [dkd_styles_value.dkd_card_pressable, dkd_pressed_value && dkd_styles_value.dkd_card_pressable_pressed]}
              >
                <LinearGradient
                  colors={['rgba(167,243,208,0.28)', 'rgba(125,211,252,0.22)', 'rgba(249,168,212,0.18)', 'rgba(13,28,44,0.96)']}
                  start={dkd_make_native_axis_point(0, 0)}
                  end={dkd_make_native_axis_point(1, 1)}
                  style={dkd_styles_value.dkd_card}
                >
                  <View style={dkd_styles_value.dkd_card_top_row}>
                    <View style={[dkd_styles_value.dkd_icon_shell, dkd_styles_value.dkd_icon_shell_service_partner]}>
                      <MaterialCommunityIcons name="store-cog-outline" size={27} color="#07131C" />
                    </View>
                    <View style={dkd_styles_value.dkd_badge}><Text style={dkd_styles_value.dkd_badge_text}>İşletme</Text></View>
                  </View>
                  <Text style={dkd_styles_value.dkd_card_title}>Hizmet Ağı İşletme Başvurusu</Text>
                  <Text style={dkd_styles_value.dkd_card_description}>Ev, teknik servis, araç destek, taşıma, yemek/market ve özel teslimat kategorilerinde işletme profilini oluştur.</Text>
                  <View style={dkd_styles_value.dkd_card_footer}>
                    <Text style={dkd_styles_value.dkd_card_footer_text}>İşletme formunu aç</Text>
                    <MaterialCommunityIcons name="arrow-right-circle" size={18} color="#FFFFFF" />
                  </View>
                </LinearGradient>
              </Pressable>
            ...
            <View style={dkd_styles_value.dkd_info_panel}>
              ...
              <Text style={dkd_styles_value.dkd_info_text}>Başvurular admin onayına düşer. Onaylandıktan sonra ilgili kurye, nakliye veya hizmet ağı işletme paneli otomatik olarak aktifleşir.</Text>
            </View>
            </View>
            ) : (
            <View style={dkd_styles_value.dkd_form_stage}>
              ...
              {dkd_active_application_value === 'courier' ? (
                ...
                <DkdServicePartnerApplicationPanel dkd_profile_value={dkd_profile_value} />
              ) : (
...
const dkd_styles_value = StyleSheet.create({
  ...
  dkd_icon_shell_service_partner: { backgroundColor: '#A7F3D0', borderColor: 'rgba(255,255,255,0.45)' },
