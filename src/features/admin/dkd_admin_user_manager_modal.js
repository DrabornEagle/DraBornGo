...
const styles = StyleSheet.create({
  ...
  kicker: { color: '#80E8FF', fontSize: 11, fontWeight: '900', letterSpacing: 1.3 },
  title: { color: '#FFF', fontSize: 27, fontWeight: '900', marginTop: 2 },
  sub: { color: 'rgba(233,243,255,.60)', fontSize: 12.5, lineHeight: 15, marginTop: 2, fontWeight: '700' },
  ...
  userMeta: { color: 'rgba(229,241,255,.58)', fontSize: 12.5, marginTop: 2 },
  ...
  userPillText: { color: '#A9EEFF', fontSize: 11, fontWeight: '900' },
  ...
  identityId: { color: '#8FE9FF', fontSize: 11, marginTop: 3 },
  identityMeta: { color: 'rgba(233,243,255,.62)', fontSize: 12, marginTop: 3 },
  sectionTitle: { color: '#A9EEFF', fontSize: 12, fontWeight: '900', letterSpacing: 1.2, marginTop: 20, marginBottom: 9 },
  ...
  metricLabel: { color: 'rgba(244,249,255,.68)', fontSize: 11, fontWeight: '800', marginTop: 10 },
  ...
  fieldLabel: { color: 'rgba(224,239,255,.62)', fontSize: 11, fontWeight: '900', marginBottom: 5 },
