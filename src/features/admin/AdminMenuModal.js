...
const styles = StyleSheet.create({
  ...
  kicker: { color: '#83E9FF', fontSize: 11, fontWeight: '900', letterSpacing: 1.3 },
  title: { color: cityLootTheme.colors.text, fontSize: 25, fontWeight: '900', marginTop: 3 },
  sub: { color: cityLootTheme.colors.textSoft, fontSize: 12.5, lineHeight: 15, marginTop: 3 },
  ...
  statusText: { color: '#DFFFF2', fontSize: 12.5, fontWeight: '900' },
  content: { paddingTop: 6, paddingBottom: 10 },
  section: { color: '#A9EEFF', fontSize: 11, fontWeight: '900', letterSpacing: 1.2, marginTop: 13, marginBottom: 8 },
