...
const dkd_styles_value = StyleSheet.create({
  ...
  dkd_brand_text: { color: '#75E8FF', fontSize: 13.5, fontWeight: '900', letterSpacing: 1.2 },
  ...
  dkd_version_text: { color: '#FFD978', fontSize: 12.5, fontWeight: '900' },
  ...
  dkd_city_text: { color: 'rgba(231,241,255,0.62)', fontSize: 13.5, fontWeight: '700' },
  ...
  dkd_control_brand_pill_text: { color: '#C9F5FF', fontSize: 12, fontWeight: '900', letterSpacing: 1.05 },
  ...
  dkd_network_pill_text: { color: '#FFFFFF', fontSize: 12.5, fontWeight: '900' },
  ...
  dkd_gate_icon_label_text: { color: '#CFF7FF', fontSize: 11.5, fontWeight: '900', letterSpacing: 0.7 },
  dkd_control_copy: { flex: 1, minWidth: 0 },
  dkd_control_kicker: { color: 'rgba(235,247,255,0.70)', fontSize: 12.5, fontWeight: '900', letterSpacing: 1.4 },
  dkd_control_title: { color: '#FFFFFF', fontSize: 29, fontWeight: '900', marginTop: 4, letterSpacing: -0.8 },
  dkd_control_subtitle: { color: 'rgba(244,248,255,0.70)', fontSize: 13.5, lineHeight: 18, fontWeight: '700', marginTop: 4 },
  ...
  dkd_status_metric_label: { color: 'rgba(239,247,255,0.48)', fontSize: 12, fontWeight: '900', letterSpacing: 0.9, marginTop: 7 },
  dkd_status_metric_value: { color: '#FFFFFF', fontSize: 13.5, fontWeight: '900', marginTop: 2 },
  ...
  dkd_order_console_kicker: { color: '#C9F5FF', fontSize: 12, fontWeight: '900', letterSpacing: 1.05 },
  ...
  dkd_order_signal_text: { color: '#FFFFFF', fontSize: 11.5, fontWeight: '900' },
  ...
  dkd_order_step_label: { flex: 1, color: 'rgba(238,247,255,0.66)', fontSize: 12, fontWeight: '800' },
  ...
  dkd_location_warning_title: { color: '#FFF1BC', fontSize: 13.5, fontWeight: '900' },
  dkd_location_warning_sub: { color: 'rgba(255,241,188,0.66)', fontSize: 13.5, lineHeight: 15, fontWeight: '700', marginTop: 2 },
  ...
  dkd_section_kicker: { color: '#78DFFF', fontSize: 13.5, fontWeight: '900', letterSpacing: 1.4 },
  ...
  dkd_action_card_badge_text: { color: '#FFFFFF', fontSize: 12.5, fontWeight: '900' },
  dkd_action_card_kicker: { color: 'rgba(220,244,255,0.62)', fontSize: 12.5, fontWeight: '900', letterSpacing: 1.2, marginTop: 16 },
  dkd_action_card_title: { color: '#FFFFFF', fontSize: 24, fontWeight: '900', marginTop: 3, letterSpacing: -0.6 },
  dkd_action_card_subtitle: { color: 'rgba(238,246,255,0.66)', fontSize: 14, lineHeight: 17, fontWeight: '700', marginTop: 6 },
  dkd_action_card_footer: { marginTop: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  dkd_action_card_cta: { color: '#E7FBFF', fontSize: 13.5, fontWeight: '900' },
  ...
  dkd_quick_subtitle: { color: 'rgba(230,241,255,0.52)', fontSize: 13.5, lineHeight: 15, fontWeight: '700', marginTop: 3, paddingRight: 15 },
  ...
  dkd_privacy_title: { color: '#E9FFF6', fontSize: 13.5, fontWeight: '900' },
  dkd_privacy_sub: { color: 'rgba(226,245,237,0.55)', fontSize: 13.5, lineHeight: 15, fontWeight: '700', marginTop: 2 },
