              ...
              <View>
                <View style={styles.heroWrap}>
                  <LinearGradient colors={['rgba(15,29,54,0.98)', 'rgba(8,14,26,0.96)']} style={styles.heroCard}>
                    ...
                    {!favoriteBadge && rarestBadge ? <HighlightCard title="EN NADİR ROZET" badge={rarestBadge} description={rarestBadge && rarestBadge.desc ? rarestBadge.desc : 'Koleksiyonundaki en özel kart.'} /> : null}
                  </LinearGradient>
                </View>
