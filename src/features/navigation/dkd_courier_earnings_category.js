...
const dkd_styles_value = StyleSheet.create({
  ...
  dkd_kicker: { color: '#B8F4FF', fontSize: 12, fontWeight: '900', letterSpacing: 1.15 },
  dkd_title: { color: '#FFFFFF', fontSize: 20, fontWeight: '900', marginTop: 2 },
  dkd_subtitle: { color: 'rgba(238,247,255,.65)', fontSize: 13.5, fontWeight: '700', marginTop: 3 },
  ...
  dkd_live_timer_label: { flex: 1, color: 'rgba(238,247,255,.66)', fontSize: 12, fontWeight: '900', letterSpacing: .7 },
  ...
  dkd_live_timer_sub: { color: 'rgba(235,245,255,.52)', fontSize: 12, lineHeight: 12, fontWeight: '700', marginTop: 4 },
  ...
  dkd_period_title: { color: '#FFFFFF', fontSize: 13.5, fontWeight: '900', letterSpacing: 1 },
  ...
  dkd_period_meta: { color: 'rgba(238,247,255,.66)', fontSize: 13, fontWeight: '800', fontVariant: ['tabular-nums'] },
  ...
  dkd_lifetime_text: { flex: 1, color: '#FFE7AA', fontSize: 13.5, fontWeight: '900' },
});
