        ...
        <Animated.View pointerEvents="box-none" style={[styles.dkd_modal_motion, { opacity: dkd_entry_value, transform: [{ translateY: dkd_translate_value }, { scale: dkd_scale_value }] }]}>
          <View style={styles.dkd_modal_shell}>
            ...
            <View style={styles.dkd_header}>
              ...
              <View style={styles.dkd_header_copy}><Text style={styles.dkd_header_kicker}>DraBornGo v0.0.17</Text><Text style={styles.dkd_header_title}>Merkez Menü</Text><Text style={styles.dkd_header_sub}>Kurye ağı, kazanç, destek ve hesap araçlarına hızlı geçiş.</Text></View>
