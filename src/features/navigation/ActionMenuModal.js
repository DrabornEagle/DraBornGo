...
function ActionMenuModal({ visible, onClose, isAdmin, canCourier, onCourier, onProfile, onSupport, onAdmin, onLegalCenter, dkd_on_app_update_center_value, onLogout }) {
...
const styles = StyleSheet.create({
  ...
  dkd_header_copy: { flex: 1, minWidth: 0 }, dkd_header_kicker: { color: '#76DFFF', fontSize: 12, fontWeight: '900', letterSpacing: 1.2 }, dkd_header_title: { color: '#FFF', fontSize: 27, fontWeight: '900', marginTop: 2 }, dkd_header_sub: { color: 'rgba(235,244,255,.61)', fontSize: 11, lineHeight: 16, fontWeight: '700', marginTop: 2 },
  ...
  dkd_earnings_header: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 12 }, dkd_earnings_header_icon: { width: 46, height: 46, borderRadius: 16, backgroundColor: '#87EAFF', alignItems: 'center', justifyContent: 'center' }, dkd_earnings_kicker: { color: '#C7F7FF', fontSize: 11, fontWeight: '900', letterSpacing: 1.1 }, dkd_earnings_title: { color: '#FFF', fontSize: 18, fontWeight: '900', marginTop: 1 }, dkd_earnings_sub: { color: 'rgba(239,247,255,.58)', fontSize: 11.5, lineHeight: 13, marginTop: 2 }, dkd_earnings_refresh: { width: 38, height: 38, borderRadius: 14, backgroundColor: 'rgba(255,255,255,.08)', alignItems: 'center', justifyContent: 'center' },
  dkd_earnings_grid: { gap: 8 }, dkd_earnings_period_card: { minHeight: 93, borderRadius: 19, padding: 11, borderWidth: 1, borderColor: 'rgba(255,255,255,.09)' }, dkd_earnings_period_top: { flexDirection: 'row', alignItems: 'center', gap: 7 }, dkd_earnings_period_icon: { width: 31, height: 31, borderRadius: 11, backgroundColor: 'rgba(255,255,255,.10)', alignItems: 'center', justifyContent: 'center' }, dkd_earnings_period_label: { color: '#EAFBFF', fontSize: 11, fontWeight: '900', letterSpacing: .7 }, dkd_earnings_period_money: { color: '#FFF', fontSize: 19, fontWeight: '900', marginTop: 5 }, dkd_earnings_period_bottom: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 }, dkd_earnings_period_meta: { color: 'rgba(239,248,255,.61)', fontSize: 11, fontWeight: '700' },
  dkd_earnings_detail_row: { flexDirection: 'row', gap: 8, marginTop: 8 }, dkd_earnings_detail: { flex: 1, minHeight: 57, borderRadius: 16, backgroundColor: 'rgba(4,15,30,.28)', borderWidth: 1, borderColor: 'rgba(255,255,255,.07)', flexDirection: 'row', alignItems: 'center', gap: 8, padding: 9 }, dkd_earnings_detail_label: { color: 'rgba(237,246,255,.52)', fontSize: 11, fontWeight: '800' }, dkd_earnings_detail_value: { color: '#FFF', fontSize: 11, fontWeight: '900', marginTop: 2 },
  dkd_earnings_lifetime: { minHeight: 42, borderRadius: 14, marginTop: 8, backgroundColor: 'rgba(72,49,20,.22)', borderWidth: 1, borderColor: 'rgba(255,215,122,.12)', flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 10 }, dkd_earnings_lifetime_text: { color: '#FFE6A8', fontSize: 11.5, fontWeight: '800' },
