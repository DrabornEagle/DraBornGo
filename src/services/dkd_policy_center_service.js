...
export async function dkd_save_policy_center_config_value(dkd_input_value = {}) {
  ...
  const dkd_payload_value = {
    ...
    dkd_version_name_value: dkd_clean_policy_text_value(dkd_input_value.dkd_version_name_value || 'v0.0.15'),
    dkd_version_code_value: dkd_clean_policy_version_code_value(dkd_input_value.dkd_version_code_value || 3),
