...
const dkd_logistics_local_storage_key_value = 'dkd_draborngo_logistics_local_state_v1';
...
export async function dkd_add_logistics_message_value({ dkd_user_id_value, dkd_job_id_value, dkd_message_text_value, dkd_profile_value }) {
  ...
  const dkd_message_value = {
    ...
    dkd_sender_name: dkd_string_value(dkd_profile_value?.nickname || dkd_profile_value?.display_name, 'DraBornGo'),
