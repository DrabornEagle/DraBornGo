...
-- DraBornGo baslangic seed verileri
...
from (
  values
    ('DraBornGo Eryaman Hub', 'map', 39.9719, 32.6355, 80, 900, true, 'ERYAMAN-HUB'),
    ('DraBornGo Metro Loot', 'qr', 39.9690, 32.6220, 60, 900, true, 'METRO-QR'),
    ('DraBornGo Boss Point', 'boss', 39.9752, 32.6414, 90, 3600, true, 'BOSS-POINT')
