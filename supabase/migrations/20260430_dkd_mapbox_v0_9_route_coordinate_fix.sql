...
-- DKD Mapbox route coordinate fix: rota bozan Null Island (0,0) ve Ankara/Türkiye lat-lng ters kayıtlarını temizler.
...
declare
  ...
  dkd_customer_name_value text := coalesce(nullif(trim(coalesce(dkd_param_customer_full_name, '')), ''), 'DraBornGo Müşterisi');
