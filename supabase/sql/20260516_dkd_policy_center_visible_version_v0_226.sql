-- DraBornGo v0.227.0 - Google Play policy center visible version cleanup
-- Amaç: Uygulama içindeki Gizlilik ve Veri Merkezi metadata ekranında 0.227.0 sürüm bilgisini görünür tutmak.
...
create table if not exists public.dkd_policy_center_config (
  ...
  dkd_version_name_value text not null default '0.227.0',
  dkd_version_code_value integer not null default 226,
