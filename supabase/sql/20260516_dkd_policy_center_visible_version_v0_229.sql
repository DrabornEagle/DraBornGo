-- DraBornGo v0.229.0 - Google Play UGC ve Gizlilik Merkezi metadata güncellemesi
-- Amaç: Uygulama içindeki Gizlilik ve Veri Merkezi metadata ekranında 0.229.0 sürüm bilgisini görünür tutmak.
-- Etki: Yalnızca public.dkd_policy_center_config tek satırlık metadata kaydını günceller.
-- Kullanıcı verisi, sipariş, cüzdan, profil, sohbet veya ödeme kaydı değiştirmez.
...
create table if not exists public.dkd_policy_center_config (
  ...
  dkd_version_name_value text not null default '0.229.0',
  dkd_version_code_value integer not null default 229,
